...
const SelfRegisteredRecordForm = ({
  isLoading,
  documentTypes,
}: {
  isLoading: boolean;
  ...
  return (
    <Form>
      <div className="w-full grid grid-cols-2 gap-x-8 gap-y-4">
        {/* N.O = លេខរៀង */}
        {location.pathname === "/self-registered/create" && (
          <div className="mb-5">
            <label
              htmlFor="order"
            ...
            <Field
              name="order"
              className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-custom-blue block w-full p-2.5 cursor-not-allowed"
...
export default SelfRegisteredRecordForm;
